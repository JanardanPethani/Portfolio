    ...
    content: (
      <div className="relative">
        <div className="mx-auto">
          ...
          <TitleSection>3. Configure Environment Variables</TitleSection>
          <DetailSection>
...
NEXT_PUBLIC_GOOGLE_TAG_MANAGER_ID=GTM-XXXXXXXXXX  # Your GTM Container ID`}
          ...
          <TitleSection>4. Create GoogleTagManager Component</TitleSection>
          <DetailSection>
            {`Create a reusable GoogleTagManager component that initializes Google Analytics and handles the data layer setup:`}
          </DetailSection>
          <CodeSection
            language="tsx"
            code={`"use client";
  ...
  return (
    <>
      ...
      />
          ...
          <DetailSection>
            {`Finally, integrate the Google Tag Manager in the root layout of your application:`}
          </DetailSection>
          <CodeSection
            language="tsx"
  ...
  return (
    <html lang="en" suppressHydrationWarning>
      ...
      />
          ...
          <DetailSection>
            {`Implementing Google Tag Manager in a Next.js application provides a powerful way to manage various tracking tags and analytics tools. The combination of client-side tracking and proper configuration offers a robust solution for analytics integration.`}
          </DetailSection>
        ...
        <div className="mx-auto">
          ...
          <DetailSection>
            <ol className="list-decimal list-inside ml-4">
              ...
              <li>
                Click &quot;Create Credentials&quot; → &quot;Service
                Account&quot;
              </li>
              <li>
